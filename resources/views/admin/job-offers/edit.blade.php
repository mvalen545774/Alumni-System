...
<div>
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Edit Job Offer</h1>
        <p class="text-gray-500 mt-1">Update job posting information</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-md overflow-hidden">
        <div class="bg-gradient-to-r from-[#1a3c5e] to-[#2d5a7b] px-6 py-4">
            ...
            <p class="text-blue-100 text-sm mt-1 ml-8">Update the job opportunity information</p>
        </div>

        <form action="{{ route('admin.job-offers.update', $job->id) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end gap-3 mt-8 pt-4 border-t border-gray-200">
                <a href="{{ route('admin.job-offers.index') }}" class="px-5 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-xl transition">Cancel</a>
