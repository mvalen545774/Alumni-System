...
<div>
    ...
    <div class="bg-white rounded-2xl shadow-md overflow-hidden">
        ...
        <form action="{{ route('alumni.events.update', $event->id) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end gap-3 mt-8 pt-4 border-t border-gray-200">
                <a href="{{ route('alumni.events.show', $event->id) }}" class="px-5 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-xl transition">Cancel</a>
