...
<div class="max-w-2xl mx-auto">
    ...
    <form action="{{ route('alumni.events.store') }}" method="POST" class="bg-white rounded-2xl shadow-md p-6">
        @csrf
        ...
        <div class="flex justify-end gap-3 mt-6">
            <a href="{{ route('alumni.events.index') }}" class="px-4 py-2 bg-gray-300 rounded-xl">Cancel</a>
