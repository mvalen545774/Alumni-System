    ...
    <aside class="sidebar w-72 bg-gradient-to-b from-[#1a3c5e] to-[#2d5a7b] shadow-xl flex-shrink-0 overflow-y-auto">
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('alumni.events.index') }}" class="sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-white hover:bg-white/10 transition {{ request()->routeIs('alumni.events.*') ? 'bg-white/20' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
